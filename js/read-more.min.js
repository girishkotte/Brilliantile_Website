    ...
    a.fn.readMore = function(d) {
        ...
        function b(g) {
            g.each(function() {
                var h = a(this);
                var i = new c(h);
                a(this).after("<span>" + d.readMoreText + "</span>").next().addClass(d.readMoreLinkClass);
                a(this).css({
                    height: i.collapsedHeight,
                    overflow: "hidden"
                })
            })
        }
        b(e);
        a("." + d.readMoreLinkClass).click(function() {
            var g = a(this).prev();
            var h = new c(g);
